    ...
    <div class="acu-header" :class="navState === 'normal' ? 'normal' : 'search'">
      ...
      <div class="nav-animate-wrp" :class="resolveClassInner()">
       ...
       <div class="nav-animate-content nav-animate-content-2">
         <div class="content">
            <p :class="isCurrent(0,800)">关于联盟</p>
            <p :class="isCurrent(800,1600)">联盟使命</p>
            <p :class="isCurrent(1600,2000)">联盟伙伴</p>
            <p :class="isCurrent(2000,3700)">联盟案例</p>
            <p :class="isCurrent(3700,1000000)">联盟活动</p>
            <p :class="isCurrent(3700,1000000)">联系我们</p>
...
export default {
  ...
  computed:{
    left() {
      ...
      else if (this.scroll>1600){
        return [460,660]
      }
      else if (this.scroll>800){
        return [265,860]
      }
      return [70,1055]
    },
